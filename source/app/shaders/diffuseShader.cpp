...
void app::shaders::DiffuseShader::bindLightColor(const glm::vec3 &lightInt) const {
...
void app::shaders::DiffuseShader::bindLightReflectivity(const glm::vec3 &lightInt) const {
